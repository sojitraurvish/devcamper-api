...
const BootcampSchema=new mongoose.Schema({
    ...
    website:{
        type:String,
        match:[//javascript regex url ->https://stackoverflow.com/questions/3809401/what-is-a-good-regular-expression-to-match-a-url
    ...
    averageRatting:{
        ...
        max:[10,"Ratting can not be more than 10"]
    },
    averageCost:{
        type:Number,
    },
